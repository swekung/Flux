...
const localMessageDefinitions = {
    ...
    field_description: {
        ...
        local_number: 1,
        length: 6+(10*3),
        data_msg_length: 1+(10*1),
        fields: [
            {field: 'developer_data_index',    number:   0, size: 1, base_type:   2},
            {field: 'field_definition_number', number:   1, size: 1, base_type:   2},
            {field: 'fit_base_type_id',        number:   2, size: 1, base_type:   0},
            {field: 'field_name',              number:   3, size: 1, base_type:   7},
            {field: 'scale',                   number:   6, size: 1, base_type:   2},
            {field: 'offset',                  number:   7, size: 1, base_type:   1},
            {field: 'units',                   number:   8, size: 1, base_type:   7},
            {field: 'fit_base_unit_id',        number:  13, size: 1, base_type:   0},
            {field: 'native_mesg_num',         number:  14, size: 1, base_type:   0},
            {field: 'native_field_num',        number:  15, size: 1, base_type:   2},
        ],
    },
    record: {
        type: 'definition',
        ...
        data_msg_length: 1+(5*4)+3+1+(4*2)+(4*1)+1+2+2,
        fields: [
