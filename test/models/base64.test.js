...
describe('Base64', () => {
    ...
    test.skip('decode Base64 with challenge', () => {
        // "Fa0vbwJrNI-_vD3S3ePx9NrJjzhFHnHDGb1g54eHAtfw="
        // "Fa0vbwJrNI+/vD3S3ePx9NrJjzhFHnHDGb1g54eHtfw="
        // "\x15­/o\x02k4\x8F¿¼=ÒÝãñôÚÉ\x8F8E\x1EqÃ\x19½`ç\x87\x87\x02×ð"
        // "\x15­/o\x02k4\x8F¿¼=ÒÝãñôÚÉ\x8F8E\x1EqÃ\x19½`ç\x87\x87µü"
    ...
    // test('array to string 2', () => {
    //     expect(Array.from(base64.stringToArray2(
    //         "Fa0vbwJrNI-_vD3S3ePx9NrJjzhFHnHDGb1g54eHtfw"
    //     ))
    //           ).toEqual(
    //               [21, 173, 47, 111, 2, 107, 52, 143, 191, 188, 61, 210, 221, 227, 241, 244, 218, 201, 143, 56, 69, 30, 113, 195, 25, 189, 96, 231, 135, 135, 181, 252]
    //           );
    // });
    ...
    test('array to string', () => {
        ...
        expect(base64.arrayToString([
            ...
            "cg9+dfv+1nbj7A+XWnNBY35aOtQ8jITBYtxJa/ClZjM="
            // "cg9-dfv-1nbj7A-XWnNBY35aOtQ8jITBYtxJa_ClZjM"
        );
...
// on server:
// [21, 173, 47, 111, 2, 107, 52, 143, 191, 188, 61, 210, 221, 227, 241, 244,
//  218, 201, 143, 56, 69, 30, 113, 195, 25, 189, 96, 231, 135, 135, 181, 252]
...
// var ch1Server = [93, 209, 166, 126, 236, 108, 162, 62, 17, 116, 236, 60, 97, 68, 98, 65, 45, 235, 193, 1, 141, 127, 43, 2, 14, 126, 76, 152, 237, 39, 13, 124,];

// var ch3Server = [21, 173, 47, 111, 2, 107, 52, 143, 191, 188, 61, 210, 221, 227, 241, 244, 218, 201, 143, 56, 69, 30, 113, 195, 25, 189, 96, 231, 135, 135, 181, 252];

// var ch1Client = "XdGmfuxsoj4RdOw8YURiQS3rwQGNfysCDn5MmO0nDXw";
// var ch3Client = "Fa0vbwJrNI-_vD3S3ePx9NrJjzhFHnHDGb1g54eHtfw";

// var ch1Expected = "XdGmfuxsoj4RdOw8YURiQS3rwQGNfysCDn5MmO0nDXw=";
// var ch3Expected = "Fa0vbwJrNI+/vD3S3ePx9NrJjzhFHnHDGb1g54eHtfw=";
// atob(_unURI(ch3Client))
